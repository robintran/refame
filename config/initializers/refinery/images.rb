Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:medium=>"250x285", :title => "531x544"}
  ...
  # config.dragonfly_secret = "5da3c0e110fc3b1a7f945518db764dfd7d70df18309b3ca2"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/home/ducle/projects/refame/public/system/refinery/images"
